SkillBridge AI <p><small>Best View in Dark Mode (Recommended)</small></p><br/>

<div align="center">

# 🎓 **SkillBridge AI**
### *An AI-Powered Resume Analyzer & Career Guidance System*

**Developed By:** Subhajit Maity  
**College:** Bengal College of Engineering and Technology  
**Academic Year:** 2022–2026  

🚀 SkillBridge AI helps students and job-seekers analyze resumes, identify skill gaps,  
and get AI-driven recommendations to bridge the gap between academics and industry.
...
SkillBridge AI is designed specifically for students and freshers to:
- Identify missing skills in resumes
- Improve ATS compatibility
- Get career-oriented recommendations
...
Follow these steps to run SkillBridge AI:  
...
Open a terminal and run:
   ...
   ```bash
  The project is provided directly as source code for academic evaluation.
...
Visit  **[Google AI Studio – Gemini API Access]** 👉 Grab and use your **own API key** — Since Mine One Have Usage Limits.
...
##  <img src="https://github.com/user-attachments/assets/5b3cb883-6652-4525-a352-b4b9a3501e07" width = 35px height = 35px> **Why Users Love SkillBridge AI**  
...
> **_This repository is maintained by [Subhajit Maity](https://github.com/Subhajit7679)._**  
> Have suggestions? Feel free to reach out to [me via email](mailto:subhajitmaity888@gmail.com). 📧
