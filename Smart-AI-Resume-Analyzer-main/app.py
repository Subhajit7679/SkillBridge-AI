    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/Subhajit7679?tab=repositories' target='_blank' style='text-decoration: none;'>
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://www.linkedin.com/in/subhajit-maity-9090a8253?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>Subhajit Maity</b>
                </a>
            </p>
     ...
     "124852522.jpeg")
        ...
        st.markdown("""
            <div class="hero-section">
                <h1 class="hero-title">About SkillBridge AI</h1>
        ...
        st.markdown(f"""
            <div class="profile-section">
                ...
                <h2 class="profile-name">Subhajit Maity</h2>
                <p class="profile-title">Full Stack Developer & AI/ML Enthusiast</p>
                <div class="social-links">
                    <a href="https://github.com/Subhajit7679" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/subhajit-maity-9090a8253?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:subhajitmaity888@gmail.com" class="social-link" target="_blank">
                        <i class="fas fa-envelope"></i>
                    </a>
                </div>
                <p class="bio-text">
                    Hello! I'm a passionate Full Stack Developer with expertise in AI and Machine Learning.
                    I created SkillBridge AI to revolutionize how job seekers approach their career journey.
        ...
        st.markdown("""
            <div class="vision-section">
                ...
                <p class="vision-text">
                    "SkillBridge AI represents my vision of democratizing career advancement through technology.
